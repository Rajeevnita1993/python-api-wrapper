...
class TheCatApi(Generic[Model]):
    def __init__(self, hostname: str = 'api.thecatapi.com', api_key: str = '', ver: str = 'v1', ssl_verify: bool = True, logger: logging.Logger = None, page_size: int = 5):
    ...
    def _page(self, endpoint: str, model: Type[Model], max_amt: int = 100) -> Iterator[Model]:
        amt_yielded = 0
